...
import ejercicios.ParcelaModificado;
 ...
 * @author Blanca
 */
public class mainParcelaModificado {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        ParcelaModificado p1 = new ParcelaModificado("monte negro", 1000f, 2000f,400f);
        ...
        ParcelaModificado p3;
        ParcelaModificado p2 = p3 = new ParcelaModificado("monte negro", 1000f, 2000f,400f);
        
        ParcelaModificado p4 = new ParcelaModificado("bosque verde", 1000f, 2000f,400f);
        ...
        if(p4.igualdadIdentidad(p3)){
            ...
            System.out.println("La parcela P4 y P3 no tienen la misma identidad");
        }
