...
public class CivitasJuego {
    ...
    private void inicializaMazoSorpresas(){
        this.mazo.alMazo(new SorpresaCobrarPagar("Paga por gastos escolares", -1000));
        this.mazo.alMazo(new SorpresaCobrarPagar("Recibes el rescate por el seguro de tus edificios", 990));
        this.mazo.alMazo(new SorpresaCobrarPagar("Te pagan por intereses", 100));
        this.mazo.alMazo(new SorpresaCobrarPagar("Has ganado un concurso de crucigramas", 1000));
        this.mazo.alMazo(new SorpresaCobrarPagar("Multa por embriaguez", -2000));
        this.mazo.alMazo(new SorpresaCobrarPagar("Multa por exceso de velocidad", -1500));
        this.mazo.alMazo(new SorpresaPorCasaHotel("La inspección de calles te obliga a hacer reparaciones", -1500));
        this.mazo.alMazo(new SorpresaPorCasaHotel("Paga el seguro por cada casa", -2000));
        this.mazo.alMazo(new SorpresaPorCasaHotel("Ganas un concurso de edificios, te dan 300 por edificio", 300));
        this.mazo.alMazo(new SorpresaPorCasaHotel("Es tu cumpleaños, recibes 100 por cada edificio ", 100));
        this.mazo.alMazo(new SorpresaConvertirme("Te conviertes en un Jugador Especulador"));
    }
