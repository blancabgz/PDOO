...
public class CivitasJuego {
    ...
    private void inicializaTablero(MazoSorpresas mazo){
        ...
        // EXAMEN
        this.tablero.anadeCasilla(new Casilla(TipoCasilla.CONTROL_POLICIAL, "Control Policial", 2.5f));
        // FIN EXAMEN
    ...
    // EXAMEN : he cambiado la vista a la siguiente mas restrictiva para probar en el main que funcione 
    void avanzaJugador(){
    // FIN EXAMEN
