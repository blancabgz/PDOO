...
public class Jugador implements Comparable<Jugador>{
    ...
    public String toString(){
        return " " + this.getNombre() + " tiene " + this.cantidadCasasHoteles() + " propiedades, se encuentra en la casilla " + this.getCasillaActual() + " y su saldo actual es " + this.getSaldo();
    }
    ...
    // EXAMEN
        boolean controlPolicial(int actual, ArrayList<Jugador> todos, float multa){
            this.toString();
            if(this.modificaSaldo(multa));
            return false;
